...
除此之外，`<p>` 和`<span>`只能包含**文本类**内容，如文本、图像、超链接、文本格式化元素(`<em>`等)和表单控件等内容；**`<p>`可以包含`<span>`元素，但`<span>`不能包含`<p>`元素；**
...
[http://blog.csdn.net/qiantujava/article/details/18305709](http://blog.csdn.net/qiantujava/article/details/18305709)
